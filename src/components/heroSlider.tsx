            ...
            <CarouselItem key={item.title} className=" ba">
              ...
              <div className="absolute w-full h-full top-0 flex justify-center items-center ">
                <div className="text-center bg-black/40 w-[80%] md:w-[60%]  rounded-lg p-5 space-y-3">
                  ...
                  <h1 className="text-xs md:text-sm lg:text-lg text-white/70 font-sans">
                    {item.subTitle}
                  </h1>
                  <button className="px-1 py-1.5 rounded-sm  w-24 h-9 bg-primary hover:bg-primary/80 text-sm text-primary-foreground font-bold  ">
                    Book Now
                  </button>
                </div>
              </div>
